...
async function runTests() {
  ...
  if (props2.quizCardDueDate === 'New card') {
    console.log(`  ❌ FAIL: quizCardDueDate should not be 'New card' for a reviewed card`);
    exitCode = 1;
  } else {
    console.log(`  ✅ quizCardDueDate shows due status for reviewed card`);
  }
  ...
  const nextEp = getNextEpisode(state);
